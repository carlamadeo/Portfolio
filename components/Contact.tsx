...
const Contact = (props: Props) => {
  ...
  function sendEmail(e: React.FormEvent<HTMLFormElement>) {
    ...
    const templateID = 'template_4un5lec';
    const publicID = 'l5LYbgm0yYmnX-HHb';

    emailjs
      .sendForm(serviceID, templateID, e.currentTarget, publicID)
      .then(
        (result) => {
    ...
    window.alert('Thank you for your message! I will contact you');
  }
      ...
      <section className='text-xs lg:text-lg text-gray-600 h-screen max-w-7xl px-10 justify-evenly mx-auto items-center'>
        ...
        <div className='container px-5 py-24 mx-auto'>
          <div className='flex flex-col text-center w-full mb-12'>
            <p className='lg:w-2/3 mx-auto leading-relaxed text-lg font-bold'>Get in touch with me 🙂</p>
          </div>
          <div className='lg:w-1/2 md:w-2/3 mx-auto'>
            <form onSubmit={sendEmail} className='flex flex-wrap -m-2'>
              ...
              <div className='p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center'>
                <a className='text-indigo-500'>carlamadeo@gmail.com</a>
